...
public class UserDaoImpl implements UserDao {
    ...
    public Address getBillingAddress(User user) {
        String selectQuerry = "FROM Address WHERE user =:user AND billing =:billing";
        try {
            return sessionFactory.getCurrentSession()
    ...
    @Override
    public List<Address> listShippingAddressess(User user) {
        String selectQuerry = "FROM Address WHERE user =:user AND shipping =:shipping";
        try {
            return sessionFactory.getCurrentSession()
                    .createQuery(selectQuerry, Address.class)
                    .setParameter("user", user)
